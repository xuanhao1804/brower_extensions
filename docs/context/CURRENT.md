...
- **Latest completed product task:** [#6 — Support YouTube mini-player with one badge](https://github.com/xuanhao1804/brower_extensions/issues/6), latest follow-up commit `5d5ea24`.
