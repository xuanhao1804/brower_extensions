...
- **Latest completed product task:** [#16 — Separate speed and 10-second seek controls](https://github.com/xuanhao1804/brower_extensions/issues/16), implementation commits `962eea9` and `a3d7eb9`.
