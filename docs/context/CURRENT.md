...
- **Latest completed product task:** [#18 — Avoid YouTube Shorts top control overlap](https://github.com/xuanhao1804/brower_extensions/issues/18), implementation commits `e0fb62f` and `bddee2c`.
